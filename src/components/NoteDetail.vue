      ...
      <div class="note-detail-ct" v-show="curNote.id">
        ...
        <div class="note-title">
          <input type="text" v-model:value="curNote.title" @input="onUpdateNote"
                 @keydown="statusText='正在输入...'" placeholder="输入标题"></input>
        </div>
        <div>
          <textarea  v-model:value="curNote.content" @input="onUpdateNote" v-show="!isShowPreview"
...
export default {
  ...
  computed:{
    ...
    previewContent(){
      return new MarkdownIt().render(this.curNote.content||'')//使用markdown模板
    },
